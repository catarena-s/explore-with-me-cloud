...
import dev.shvetsova.ewmc.event.dto.event.EventShortDto;
import dev.shvetsova.ewmc.event.dto.event.NewEventDto;
import dev.shvetsova.ewmc.event.dto.event.UpdateEventUserRequest;
