...
public class EventRequestStatusUpdateRequest {
    ...
    public void setRequestIds(@NotNull(message = "RequestId list cannot be null.") @NotEmpty(message = "RequestId list cannot be empty.") List<Long> requestIds) {
        this.requestIds = requestIds;
    }

    public void setStatus(@NotNull(message = "Request status cannot be null or empty.") String status) {
        this.status = status;
    }
